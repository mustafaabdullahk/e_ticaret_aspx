...
public partial class BBB : System.Web.UI.Page
{
    ...
    {
        string sorgu = "SELECT urunler.URUNID, urunler.RESIM, markalar.MARKA, urunler.URUNAD, urunler.BIRIMFIYAT, urunler.STOK FROM markalar INNER JOIN urunler ON markalar.MARKAID = urunler.MARKAID WHERE (((urunler.KATEGORI)="+tirnak+"BBB"+tirnak+")) ORDER BY urunler.KATEGORISIRA;";
