...
public partial class EBB : System.Web.UI.Page
{
    ...
    {
        string sorgu = "SELECT urunler.URUNID, urunler.RESIM, markalar.MARKA, urunler.URUNAD, urunler.BIRIMFIYAT, urunler.STOK FROM markalar INNER JOIN urunler ON markalar.MARKAID = urunler.MARKAID WHERE (((urunler.KATEGORI)=" + tirnak + "EBB" + tirnak + ")) ORDER BY urunler.KATEGORISIRA;";
